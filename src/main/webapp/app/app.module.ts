...
import { JhipsterFirstApplicationSharedModule, UserRouteAccessService } from './shared';
...
import { JhipsterFirstApplicationAdminModule } from './admin/admin.module';
...
@NgModule({
    imports: [
        ...
        JhipsterFirstApplicationAdminModule,
